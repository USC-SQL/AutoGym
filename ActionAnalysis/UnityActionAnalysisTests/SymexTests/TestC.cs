...
namespace UnityActionAnalysis.Tests
{
    ...
    public class TestC
    {
        ...
        {
            using (SymexMachine machine = SymexTestHelpers.CreateMachine("UnityActionAnalysisTestCases.Symex.TestC.ProgramC", "Main", new TestConfig()))
            {  
                machine.Run();
                ...
                using (var z3 = new Context(new Dictionary<string, string>() { { "model", "true" } }))
                {
                    ...
                    {
                        if (SymexTestHelpers.ModelContainsVariables(m, arg4))
                        {
                    ...
                    Assert.IsTrue(helper.ExistsState((s, m) =>
                    {
                        if (SymexTestHelpers.ModelContainsVariables(m, arg0, arg1, arg2, arg3, arg4))
                        {
