...
namespace UnityActionAnalysis
{
    ...
    public class SymexState 
    {
        ...
        public Expr MakeSymbolicValue(IType type, string name)
        {
            ...
            {
                throw new SymexUnsupportedException("MakeSymbolicValue for type of kind " + type.Kind + " not implemented");
            }
        }
        ...
        public void EnqueueOp(Operation op)
        {
            opQueue.Enqueue(op);
        }

        public void EnqueueOp(Action<SymexState> op)
        {
            EnqueueOp(new Operations.Custom(op));
        }
