        ...
        public override void Perform(SymexState state)
        {
            ...
            switch (op)
            {
                case BinaryNumericOperator.Add:
                    ...
                    {
                        result = z3.MkAdd((RealExpr)value1, (RealExpr)value2);
                    }
                    break;
                case BinaryNumericOperator.Sub:
                    ...
                    {
                        result = z3.MkSub((RealExpr)value1, (RealExpr)value2);
                    }
                    break;
                case BinaryNumericOperator.Mul:
                    ...
                    {
                        result = z3.MkMul((RealExpr)value1, (RealExpr)value2);
                    }
                    break;
                case BinaryNumericOperator.Div:
                    ...
                    {
                        result = z3.MkDiv((RealExpr)value1, (RealExpr)value2);
                    }
                    break;
                case BinaryNumericOperator.Rem:
                    ...
                    {
                        result = z3.MkInt2Real(z3.MkRem(z3.MkReal2Int((RealExpr)value1), z3.MkReal2Int((RealExpr)value2)));
                    }
                    break;
