            ...
            } else
            {
                ...
                switch (op)
                {
                    ...
                    case ComparisonKind.LessThan:
                        ...
                        {
                            result = z3.MkLt((RealExpr)value1, (RealExpr)value2);
                        }
                        break;
                    case ComparisonKind.LessThanOrEqual:
                        ...
                        {
                            result = z3.MkLe((RealExpr)value1, (RealExpr)value2);
                        }
                        break;
                    case ComparisonKind.GreaterThan:
                        if (isBV)
                        ...
                        {
                            result = z3.MkGt((RealExpr)value1, (RealExpr)value2);
                        }
                        break;
                    case ComparisonKind.GreaterThanOrEqual:
                        ...
                        {
                            result = z3.MkGe((RealExpr)value1, (RealExpr)value2);
                        }
                        break;
                    default:
