...
namespace UnityActionAnalysis
{
    ...
    public class InputManagerSettings
    {
        ...
        public static readonly KeyCode KEYCODE_MOUSEX_NEG = KeyCode.Joystick8Button16;
        public static readonly KeyCode KEYCODE_MOUSEX_POS = KeyCode.Joystick8Button17;
        public static readonly KeyCode KEYCODE_MOUSEY_NEG = KeyCode.Joystick8Button18;
        public static readonly KeyCode KEYCODE_MOUSEY_POS = KeyCode.Joystick8Button19;
        ...
        public InputManagerSettings(string settingsPath, InputManagerMode mode)
        {
            ...
            foreach (var axisData in data.m_Axes)
            {
                ...
                if (axisData.type == 0) // Key or Mouse Button
                {
                ...
                } else if (axisData.type == 1) // Mouse Axis
                {
                    switch (axisData.axis)
                    {
                        case 0: // Mouse X
                            positiveKeyCode = KEYCODE_MOUSEX_POS;
                            negativeKeyCode = KEYCODE_MOUSEX_NEG;
                            break;
                        case 1: // Mouse Y
                            positiveKeyCode = KEYCODE_MOUSEY_POS;
                            negativeKeyCode = KEYCODE_MOUSEY_NEG;
                            break;
                        default:
                            positiveKeyCode = null;
                            negativeKeyCode = null;
